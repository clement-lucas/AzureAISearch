...
namespace DocumentSearchPortal.Models.ViewModels
{
    ...
    public class UploadViewModel
    {
        ...
        //public List<string> AvailableContainers { get; set; } = new List<string> { "Normal", "SQL+Normal" };

        //[Required(ErrorMessage = "Containerの選択は必須です。")]
        //public List<string> SelectedContainers { get; set; } = new List<string> { "Normal" };
    }
}
